  ...
  return (
    <div className="register-container">
      <div className="register-card">
        ...
        <div className="register-form-panel">
          <div className="logo-section">
            ...
            <h1 className="welcome-title">Join Apers</h1>
          ...
          <div className="social-login-section">
            <button
              className={`social-button direct-signup-button ${isLoading ? 'loading' : ''}`}
            ...
            >
              <div className="button-content"> 
                <svg className="social-icon" viewBox="0 0 24 24"> 
                  ...
                  <span className="button-text"> {isLoading ? 'Signing in...' : 'Continue with Google'} </span> 
                </div>
            </button>
          </div>
        ...
        <div className="hero-panel">
          <div className="hero-content">
            ...
            <div className="hero-text">
              ...
              <p>Join our community and discover how Apers can transform your workflow and productivity.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .direct-signup-button:hover:not(:disabled) {
